...
int I2SClass::read(void* buffer, size_t size)
{
  ...
  read = _doubleBuffer.read(buffer, size);
...
void I2SClass::onDmaTransferComplete(int channel)
{
  ...
  if (I2S_SCK._dmaChannel == channel) {
    I2S_SCK.onTransferComplete();
  }
#endif
}

#if I2S_INTERFACES_COUNT > 0
I2SClass I2S_SCK(I2S_DEVICE, I2S_CLOCK_GENERATOR, PIN_I2S_SD, PIN_I2S_SCK, PIN_I2S_FS);
#endif
